...
const theme = {
	...
	themes: {
		...
		dark: {
			dark: true,
			colors: {
				'primary': localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#f35c19',
				'on-primary': '#fff',
				'secondary': '#A8AAAE',
				'on-secondary': '#fff',
				'success': '#28C76F',
			...
			variables: {
				...
				// 'shadow-key-umbra-opacity': 'rgba(243, 92, 25, 0.15)',
				// 'shadow-key-penumbra-opacity': 'rgba(243, 92, 25, 0.01)',
				// 'shadow-key-ambient-opacity': 'rgba(243, 92, 25, 0.08)',
			},
		},
	},
}
