      ...
      >
        ...
        >
          ...
          <VCardText>
            ...
            <div>Máximo de tokens: <strong>{{ formatIGCToken(totalSupply) }}</strong></div>
            <div>Total de tokens queimados: <strong>{{ formatIGCToken(deadCoin) }}</strong></div>
            <div>Total de tokens para mineração: <strong>{{ formatIGCToken(gamePool) }}</strong></div>
            <div>Total de tokens bloqueados: <strong>{{ formatIGCToken(valueLocked) }}</strong></div>
            <div>Total de tokens para venda: <strong>{{ formatIGCToken(qtdPresale) }}</strong></div>
          </VCardText>
        </VCard>
      </VCol>
    </VRow>
